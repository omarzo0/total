...
$query = "SELECT id, client_name, sand, money, photo, DATE_FORMAT(date, '%m/%d/%Y') AS formatted_date
              FROM term_clients 
              WHERE 1 $whereClause";
...
echo '<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet"
    ...
    echo '<title>عملاء أجله</title>';
echo '<body>';
echo '<div class="main-body1">';
echo'<div class="nav1">';
echo '<h1>عملاء أجله</h1>';
echo '</div>';
...
echo '<div class="header__item"> <a id="draws" class="filter__link filter__link--number" href="#"> العميل</a></div>';
echo '</div>';       
echo '<div class="table-content">';	
   // Display data in the table
   if ($num_clients === 0) {
    echo '<div class="table-row">لا يوجد عملاء<br><br></div>';
} else {
