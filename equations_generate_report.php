...
if (is_logged_in() || $_SESSION['id'] == 1) {
    ...
    $query = "SELECT photo, id, name, sand, money,  DATE_FORMAT(date, '%m/%d/%Y') AS formatted_date
              FROM hsabat 
              WHERE 1 $whereClause";
...
echo ' <div class="header__item"><a id="draws" class="filter__link filter__link--number" href="#">المحاسب</a></div>';
echo '</div>';       
